package com.cute.java.generator.action.config;
...
public class CuteGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("liuqiang");
    }
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/cute?characterEncoding=utf8");
    }
    ...
    protected void contextConfig() {
        contextConfig.setProPackage("com.cute.java.admin");
        contextConfig.setCoreBasePackage("com.cute.java.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\cute\\cute-admin");//写自己项目的绝对路径
