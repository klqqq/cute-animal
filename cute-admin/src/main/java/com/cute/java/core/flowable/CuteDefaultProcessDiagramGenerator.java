...
package com.cute.java.core.flowable;
 ...
 */
public class CuteDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public CuteDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public CuteDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
