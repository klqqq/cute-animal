...
import com.cute.java.core.common.constant.dictmap.MenuDict;
...
import com.cute.java.core.support.BeanKit;
import com.cute.java.core.util.ToolUtil;
import com.cute.java.modular.system.model.Menu;
import com.cute.java.modular.system.service.IMenuService;
import com.cute.java.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new CuteException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new CuteException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
