package com.cute.java.modular.code.factory;


import com.cute.java.CuteApplication;
import com.cute.java.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("liuqiang");
        genQo.setProjectPackage(CuteApplication.class.getPackage().getName());
